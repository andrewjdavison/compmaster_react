...
class Compinst extends Table {
    constructor(model){
      super({
              tableName:'compinst',
              schema : {
                 compstate : { type: 'INT(11)',  notnull : true, value   : 0,},
                 ...
                 contactName: { type: 'VARCHAR(200)',  notnull : true,},
                 contactPhone: { type: 'VARCHAR(200)',  notnull : true,},
                 contactEmail: { type: 'VARCHAR(200)',  notnull : true,},
...
//                 acceptingEntries : { type: 'TINYINT(4)',  notnull : true, value   : 0,},
                 ...
                 bannerImg: { type: 'VARCHAR(100)', notnull: true, value: '',},
                 acceptingEntries: { type: 'INT(11)', notnull:true, value:0,},
                 publishScores: { type: 'INT(11)', notnull: true, value:0,},
                 activated: { type: 'INT(11)', notnull: true, value:0,},
                 finalised: { type: 'INT(11)', notnull: true, value:0,},
                 totallimit: {type: 'INT(11)', notnull: true, value:0,},
                 categorylimit: {type: 'INT(11)', notnull: true, value:0,},
                 subcategorylimit: {type: 'INT(11)', notnull: true, value: 0,},
                multiDiscountQual: {type: 'INT(11)', notnull: true, value: 0,},
                pointspread: {type: 'INT(11)', notnull: true, value: 7,},
