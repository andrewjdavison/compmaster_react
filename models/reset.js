  ...
  constructor(model){
    super({
            ...
            schema : {
              ...
              lastLogin:        { type: 'VARCHAR(200)', notnull: true, value: null },
              lastLoginAttempt: { type: 'VARCHAR(200)', notnull: true, value: null },
              loginAttempts:    { type: 'VARCHAR(200)', notnull: true, value: null }
            }
    });
    this.set(model);
  }
